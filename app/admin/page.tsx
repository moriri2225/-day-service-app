...
const SERVICES = [
  { id: 'after_school', label: '放課後等デイサービス', color: 'bg-[#FFF0F3] text-[#D96B85] border-[#F8C3CE]' },
  { id: 'developmental_support', label: '児童発達支援', color: 'bg-[#EAF7F4] text-[#2C9381] border-[#A8DDD3]' },
];
                        ...
                        <div className="sm:col-span-2 space-y-2 pt-1">
                          ...
                          <div className="flex flex-wrap gap-3">
                            <label className="flex items-center gap-1.5 text-xs font-bold text-gray-700 cursor-pointer">
                              <input
                                type="checkbox"
                                checked={newFacilityForm.offered_services?.includes('after_school') || false}
                                onChange={() => handleNewServiceToggle('after_school')}
                            ...
                            <label className="flex items-center gap-1.5 text-xs font-bold text-gray-700 cursor-pointer">
                              <input
                                type="checkbox"
                                checked={newFacilityForm.offered_services?.includes('developmental_support') || false}
                                onChange={() => handleNewServiceToggle('developmental_support')}
                                className="w-4 h-4 text-[#2C9381] rounded"
                              />
                              児童発達支援
                            </label>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1">
                      <div>
                        ...
                        <div className="space-y-2">
                          <label className="flex items-center gap-2 cursor-pointer bg-[#FAF8F5] p-2.5 rounded-xl border border-[#E5DDD0]">
                            <input
                              type="checkbox"
                              checked={facilityForm.offered_services?.includes('after_school') || false}
                              onChange={() => handleServiceToggle('after_school')}
                              className="w-4 h-4 text-[#2C9381] rounded focus:ring-0"
                            />
                            <span className="text-xs font-bold text-gray-700">放課後等デイサービス</span>
                          </label>
                          <label className="flex items-center gap-2 cursor-pointer bg-[#FAF8F5] p-2.5 rounded-xl border border-[#E5DDD0]">
                            <input
                              type="checkbox"
                              checked={facilityForm.offered_services?.includes('developmental_support') || false}
                              onChange={() => handleServiceToggle('developmental_support')}
                              className="w-4 h-4 text-[#2C9381] rounded focus:ring-0"
                            />
                            <span className="text-xs font-bold text-gray-700">児童発達支援</span>
                          </label>
                        </div>
                      </div>
